...
int main(int argc, char * argv[])
{
  ...
  std::string topic_name = "/camera/camera/color/image_raw/compressed";
  ...
  // auto handles_2 = ros1_bridge::create_bidirectional_bridge(
  //   ros1_node, ros2_node, ros1_type_name_2, ros2_type_name_2, topic_name_2, queue_size);
  
  std::string topic_name_3 = "/camera/camera/aligned_depth_to_color/image_raw/compressedDepth";
  std::string ros1_type_name_3 = "sensor_msgs/CompressedImage";
  std::string ros2_type_name_3 = "sensor_msgs/msg/CompressedImage";

  auto handles_3 = ros1_bridge::create_bidirectional_bridge(
    ros1_node, ros2_node, ros1_type_name_3, ros2_type_name_3, topic_name_3, queue_size);
  
  std::string topic_name_cam_info = "/camera/camera/color/camera_info";
  std::string ros1_type_name_cam_info = "sensor_msgs/CameraInfo";
  std::string ros2_type_name_cam_info = "sensor_msgs/msg/CameraInfo";

  auto handles_cam_info = ros1_bridge::create_bidirectional_bridge(
    ros1_node, ros2_node, ros1_type_name_cam_info, ros2_type_name_cam_info, topic_name_cam_info, queue_size);
  
  std::string topic_name_odom = "/Odometry";
  std::string ros1_type_name_odom = "nav_msgs/Odometry";
  std::string ros2_type_name_odom = "nav_msgs/msg/Odometry";

  auto handles_odom = ros1_bridge::create_bidirectional_bridge(
    ros1_node, ros2_node, ros1_type_name_odom, ros2_type_name_odom, topic_name_odom, queue_size);
