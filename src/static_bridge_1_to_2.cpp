...
{
  // ROS 1 node
  ros::init(argc, argv, "ros1_to_ros2_bridge_host");
  ros::NodeHandle ros1_node;

  // ROS 2 node
  rclcpp::init(argc, argv);
  auto ros2_node = rclcpp::Node::make_shared("ros1_to_ros2_bridge_host");
  ...
  std::string topic_name_ros2 = "/ros2/color/image_raw/compressed";
  ...
  auto handles = ros1_bridge::create_bridge_from_1_to_2(
      ...
      ros2_type_name, topic_name_ros2, 10);
  ...
  // auto handles_2 = ros1_bridge::create_bridge_from_1_to_2(
  ...
  std::string topic_name_depth_ros2 = "/ros2/depth/image_raw/compressedDepth";
