...
int main(int argc, char * argv[])
{
  ...
  std::string topic_name = "/orbbec_camera/color/image_raw/compressed";
  ...
  std::string topic_name_3 = "/orbbec_camera/depth/image_raw/compressedDepth";
  ...
  std::string topic_name_cam_info = "/orbbec_camera/color/camera_info";
  ...
  std::string topic_name_odom = "/fastlio_odom";
